...
impl Aggregator {
    ...
    // pub async fn get_next_proof_to_verify(
    //     &mut self,
    //     storage: &mut StorageProcessor<'_>,
    //     l1_verifier_config: L1VerifierConfig,
    // ) -> Option<ProveBatches> {
    ...
    //     Self::load_real_proof_for_offchain_verify(
    //         storage,
    //         l1_verifier_config,
    ...
    // async fn load_real_proof_for_offchain_verify(
    //     storage: &mut StorageProcessor<'_>,
    //     l1_verifier_config: L1VerifierConfig,
    //     proof_loading_mode: &ProofLoadingMode,
    //     blob_store: &dyn ObjectStore,
    ...
    //         .await
    //         .unwrap();
    //     let batch_to_verify = previous_verified_batch_number + 1;

    //     if let Some(version_id) = storage
    //         .blocks_dal()
    //         .get_batch_protocol_version_id(batch_to_verify)
    //         .await
    //         .unwrap()
    //     {
    //         let verifier_config_for_next_batch = storage
    ...
    //         }
    //         ProofLoadingMode::FriProofFromGcs => {
    //             load_wrapped_fri_proofs_for_range(batch_to_verify, batch_to_verify, blob_store).await
    //         }
    //     };
    //     if proofs.is_empty() {
    //         // The proof for the next L1 batch is not generated yet
